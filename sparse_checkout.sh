...
git_folder_location='F:\GitHub\'   #replace with the local root folder location where you want to create the project folder
project_name=mlops-project   #replace with your project name
github_org_name=FallenHoot   #replace with your github org name
